...
<div class="w3-top">
  <div class="w3-bar w3-white w3-padding w3-card" style="letter-spacing:4px;">
    <a href="#home" class="w3-bar-item w3-button"><b><i>Mayur Catering</i></b></a>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1600px;min-width:500px" id="home">
  ...
  <div class="w3-display-bottomleft w3-padding-large w3-opacity">
    <h1 class="w3-xxlarge"><b>Mayur Catering</b></h1>
  </div>
</header>
...
<div class="w3-content" style="max-width:1100px">
  ...
  <div class="w3-row w3-padding-64" id="about">
    ...
    <div class="w3-col m6 w3-padding-large">
      ...
      <p class="w3-large">The Catering was founded in Bhandara by Mr.Mayur Urkude,It provides Good quality food with cleanliness <span class="w3-tag w3-light-grey"></span> </p>
  ...
  <div class="w3-container w3-padding-64" id="contact">
    ...
    <p class="w3-text-blue-grey w3-large"><b> Mayur Catering Service,Bhandara</b></p>
